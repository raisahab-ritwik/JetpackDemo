...
import com.koltech.cricscores.adapter.PagerAdapter;
...
public class MainActivity extends AppCompatActivity implements FragmentDrawer.FragmentDrawerListener {
    ...
    AdView adView;
    Runnable refresh;
    public static final String ADMOB_ID_BANNER = "ca-app-pub-4323564273755882/9281933087";
            ...
            public void onClick(View v) {
                ...
                switch (current_tab) {
                    ...
                    case 2:
                        ...
                        fragment = new IPLFragment();
                        break;
                    case 3:
                        fragment = new LastestNewsFragment();
                        break;
    ...
    public void share() {
        ...
        startActivity(Intent.createChooser(share, "Share the link of CricScores"));
    }
