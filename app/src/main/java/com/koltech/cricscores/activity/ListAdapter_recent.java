...
public class ListAdapter_recent extends BaseAdapter {
    ...
    RecentMatchFragment main;

    ListAdapter_recent(RecentMatchFragment main) {
...
/*        String[] split_batteam_score = holder.batteamscore_str.split("&");
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent opn = new Intent(main.getActivity(), FullScoreboardActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
